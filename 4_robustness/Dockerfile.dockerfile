...
COPY Chapter_4_HopSkipJump_Attack_on_ImageNet.ipynb \
    Chapter_4_Simple_Transparent_Adversarial_Examples.ipynb \
    requirements-chapter4.txt \
    README.md \
    /app/

# Install dependencies for HopSkipJumpAttack and Simple Adversarial Examples
RUN pip3 install -r requirements-chapter4.txt
